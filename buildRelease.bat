...
rem start /D $(ProjectDir)..\ /WAIT deploy.bat  $(TargetDir) $(TargetFileName)
rem
rem if $(ConfigurationName) == Release start /D $(ProjectDir)..\ /WAIT buildRelease.bat $(TargetDir) $(TargetFileName)
rem
rem 
rem
rem )
